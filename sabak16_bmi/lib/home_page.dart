...
import 'package:sabak16_bmi/constants/status_card2.dart';
import 'package:sabak16_bmi/constants/status_card_for_slader.dart';
            ...
            Expanded(
              child: Row(
                children: const [
                  ...
                  SizedBox(width: 39),
                  StatusCard(icon: Icons.female, text: AppTexts.famele),
                ],
              ),
            ),
