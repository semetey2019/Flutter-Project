          ...
          elevation: 0,
            ...
            child: Column(mainAxisAlignment: MainAxisAlignment.center,
              ...
              height: 130, width: 130, fit: BoxFit.fill,),
                ...
                const Text("Tolgonai Mamytova", style: TextStyle(fontSize: 48,
                fontFamily:'Pacifico',color: Colors.white),),
                
                const Text("Flutter Developer", style: TextStyle
                (color: Color(0xffF7F9F9),fontSize: 28),
                ),
                const Divider(
                  height: 0,
                  thickness: 2,
                ...
                ElevatedButton(style: ElevatedButton.styleFrom(side: const BorderSide(
